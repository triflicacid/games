...
function main() {
    ...
    const elMoveDelta = document.getElementById("move-delta");
    elMoveDelta.value = DELTA.toString();
    elMoveDelta.addEventListener('change', () => {
        let delta = parseInt(elMoveDelta.value);
